...
<body class="cosmic-body">
    <div class="cosmic-bg-wrap">
        ...
        <div
            style="position: absolute; width: 100%; height: 100%; background: radial-gradient(circle at 50% 50%, transparent 40%, rgba(3, 3, 5, 0.9) 100%);">
        </div>
    </div>
    ...
    <main class="glass-card animate-in">
        ...
        <form method="POST" action="?action=login" novalidate>
            ...
            <div class="field-group">
                ...
                <input type="email" id="email" name="email" class="field-input" placeholder="Enter your email"
            ...
            <div class="field-group">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                    ...
                    <button type="button" class="toggle-password"
                        style="background: none; border: none; color: var(--fg-muted); font-size: 13px; cursor: pointer; padding: 0;">Show</button>
                </div>
            ...
            <p style="text-align: center; font-size: 13px; color: var(--fg-muted);">
                New to Atomz <a href="?action=register"
                    style="color: #6366F1; font-weight: 600; text-decoration: none;">Join Now</a>
            </p>
        </form>
    </main>
    ...
    <?php $error = AppSession::getFlash('error');
    if ($error): ?>toast('error', 'Error', '<?= addslashes($error) ?>'); <?php endif; ?>
    <?php $success = AppSession::getFlash('success');
    if ($success): ?>toast('success', 'Success', '<?= addslashes($success) ?>'); <?php endif; ?>
