...
<tr><td style='padding:28px;background:linear-gradient(135deg,#0D1425,#162038);text-align:center'><h1 style='margin:0;color:#A855F7;font-size:22px;font-weight:700'>Apex Solutions</h1></td></tr>
...
<tr><td style='padding:14px 28px;background:#0D1425;text-align:center'><p style='color:#475569;font-size:10px;margin:0'>&copy; " . date('Y') . " Apex Solutions &mdash; Portal de Seguridad</p></td></tr></table></body></html>";
    }
}
